...
public class DefaultSymbolFactory implements SymbolFactory {
	// Factory methods
	/**
	 * DefaultSymbolFactory for CUP. Users are strongly encouraged to use
	 ...
	 * process, You have the chance of still using the old-style Symbols.
	 *
	 * @deprecated as of CUP v11a replaced by the new
	 *             com.github.jhoenicke.javacup.runtime.ComplexSymbolFactory
	 */
	// @deprecated
