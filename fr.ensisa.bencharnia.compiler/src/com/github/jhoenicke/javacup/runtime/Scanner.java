 ...
 * Interface Scanner
 * 
 * Declares the next_token() method that should be implemented by scanners. This
 * method is typically called by lr_parser.scan(). End-of-file can be indicated
 * either by returning <code>new Symbol(lr_parser.EOF_sym())</code> or
 * <code>null</code>.
 ***************************************************/
